...
(
    ...
    team_created_timestamp TIMESTAMP NOT NULL DEFAULT now(),
    team_updated_timestamp TIMESTAMP NOT NULL DEFAULT now(),
    CONSTRAINT team_username_length CHECK (length(team_username) >= 6 AND length(team_username) <= 50),
    CONSTRAINT team_password_length CHECK (length(team_password) >= 10 AND length(team_password) <= 50),
...
(
    ...
    student_created_timestamp TIMESTAMP NOT NULL DEFAULT now(),
    student_updated_timestamp TIMESTAMP NOT NULL DEFAULT now(),
...
(
    ...
    contact_created_timestamp TIMESTAMP NOT NULL DEFAULT now(),
    contact_updated_timestamp TIMESTAMP NOT NULL DEFAULT now(),
...
(
    ...
    parameter_created_timestamp TIMESTAMP NOT NULL DEFAULT now(),
    parameter_updated_timestamp TIMESTAMP NOT NULL DEFAULT now(),
...
(
    ...
    response_created_timestamp TIMESTAMP NOT NULL DEFAULT now(),
    response_updated_timestamp TIMESTAMP NOT NULL DEFAULT now(),
...
(
    ...
    bank_created_timestamp TIMESTAMP NOT NULL DEFAULT now(),
    bank_updated_timestamp TIMESTAMP NOT NULL DEFAULT now(),
...
(
    ...
    statistic_created_timestamp TIMESTAMP NOT NULL DEFAULT now(),
    statistic_updated_timestamp TIMESTAMP NOT NULL DEFAULT now(),
